"""
Workflow: Financing Deck / Investor Deck
...
WORKFLOW_KEY = "financing_deck"


def run(user_input: str, run_id: str | None = None) -> dict:
    """
    Execute the Financing Deck workflow.

    Args:
        user_input: Founder's raw input describing the financing task.
